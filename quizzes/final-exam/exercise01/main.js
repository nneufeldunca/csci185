function color1() {
    ...
    document.querySelector("#square1").style.backgroundColor = "blue";
}
...
function color3() {
    // TODO
    document.querySelector("#square3").style.backgroundColor = "purple";
}

function color4() {
    // TODO
    document.querySelector("#square4").style.backgroundColor = "yellow";
}
